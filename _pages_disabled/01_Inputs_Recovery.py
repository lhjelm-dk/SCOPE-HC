"""
Sub-page: Recovery Factor Inputs
...
from scopehc.ui.inputs_fluids import render_recovery


def main() -> None:
    st.session_state["current_page"] = "_pages_disabled/01_Inputs_Recovery.py"

    st.header("Recovery Factor")
